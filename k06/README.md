...
## ソースコードの説明
76:int型でi,j,xを定義
77-81:動的計画法で使用するテーブルを全て０にし、初期化する
83:メニューの数の分だけ繰り返す
84:持っている金額よりもメニューの値段の方が高い場合、テーブルの状態を引き継ぐ
88:持っている金額よりもメニューの金額の方が安い場合、所持金額が1000円になるまで繰り返す
89―94:メニューを入れ替える場合とそうでない場合のカロリーを比較し、大きい方の値をテーブルに入れる
97:最大摂取可能カロリーを出力する
